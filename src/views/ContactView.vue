<template>
    ...
    <div class="background">
        <div class="container1">
            <div class="screen">
                ...
                <div class="screen-body">
                    <div class="screen-body-item left">
                        ...
                        <div class="app-contact">CONTACT INFO : +27 12 345 6789</div>
                        <div class="app-contact">EMAIL : TechTopia@gmail.com</div>
                        <div class="app-contact">ADDRESS : 6969 Dunno Avenue, Observatory CPT</div>
            ...
            <div class="credits">
                Inspired By
                <a class="credits-link" href="http://localhost:8080/" target="_blank">
